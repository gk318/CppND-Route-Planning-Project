...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
    ...
    for (RouteModel::Node *node_neighbor : (*current_node).neighbors) {
        ...
        (*node_neighbor).g_value = (*current_node).g_value + (*current_node).distance(*node_neighbor);
...
/*double RoutePlanner::Heuristic(RouteModel::Node *nodeA, RouteModel::Node *nodeB) {
